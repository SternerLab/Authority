...
with open("evaluation_results_bhl_fini.txt", "w+") as f:
    ...
    f.write("author names found in bhl: "+str(authors_found_in_google_scholar)+"\n")
    f.write("duplicate author profiles found in bhl: "+str(duplicate_author_profiles_on_gs)+"\n")
    f.write("TP: "+str(TP)+"\n")
    f.write("FP: "+str(FP)+"\n")
    f.write("FN: "+str(FN)+"\n")
    f.write("TN: "+str(TN)+"\n")
