...
from article_m_records as tb1 INNER JOIN article_m_records as tb2
on tb1.id != tb2.id and tb1.id < tb2.id and tb1.last_name = tb2.last_name and tb1.first_name = tb2.first_name and tb1.middle_name = tb2.middle_name and tb1.suffix = tb2.suffix 
where not tb1.first_initial = ''  and not tb2.first_initial = '' 
and not tb2.middle_initial = '' and not tb1.middle_initial = ''
